...
function allSiteSwiperInit() {
  const moreSwiperBreakNormalPoints = {
    0: {
      slidesPerView: 1,
    },
    480: {
  ...
  const moreSolidFirstSec = {
    autoplay: true,
    className: ".more_solid_first_sec",
    breakpoints: moreSwiperBreakNormalPoints,
    observer: true,
    observeParents: true,
    spaceBetween: 15,
  };

  const latestProductsFirstSec = {
    autoplay: true,
    className: ".latest_products_first_sec",
    breakpoints: moreSwiperBreakNormalPoints,
    observer: true,
    observeParents: true,
    spaceBetween: 15,
  ...
  const offersFirstSec = {
    autoplay: false,
    className: ".offers_first_sec",
    breakpoints: moreSwiperBreakNormalPoints,
    observer: true,
    observeParents: true,
    spaceBetween: 15,
  ...
  const moreSolidSecondSec = {
    autoplay: false,
    className: ".more_solid_second_sec",
    breakpoints: moreSwiperBreakNormalPoints,
    observer: true,
    observeParents: true,
    spaceBetween: 15,
  ...
  const latestProductsSecondSec = {
    autoplay: true,
    className: ".latest_products_second_sec",
    breakpoints: moreSwiperBreakNormalPoints,
    observer: true,
    observeParents: true,
    spaceBetween: 15,
  ...
  const offersSecondSec = {
    autoplay: false,
    className: ".offers_second_sec",
    breakpoints: moreSwiperBreakNormalPoints,
    observer: true,
    observeParents: true,
    spaceBetween: 15,
  ...
  swiperInit(moreSolidFirstSec);
  swiperInit(latestProductsFirstSec);
  swiperInit(offersFirstSec);
  swiperInit(moreSolidSecondSec);
  swiperInit(latestProductsSecondSec);
  swiperInit(offersSecondSec);
}
